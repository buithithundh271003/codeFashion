...
//   // Filter similar products
//   useEffect(() => {
//     fetch('http://localhost:4000/api/recommendation')
//       .then(response => response.json())
//       .then(products => {
//         setData(products)
//       })
//   }, [])
//   const similarProducts = data?.filter(item =>  item._id !== product?._id);
//   console.log("kkkkkkkkkkkkk",similarProducts)
//   // Kiểm tra trước khi filter
            ...
            {/* <div className="w-full h-96 bg-gray-100 rounded-lg overflow-hidden">
              ...
              {/* <div className="w-full h-96 bg-gray-100 rounded-lg overflow-hidden flex items-center justify-center">
                ...
                />
                  ...
                  <div className="w-[300px] h-[450px] bg-white flex items-center justify-center">
  <img
    src={product?.images[0]?.response?.urls?.[0]?.url}
    alt={product?.name}
